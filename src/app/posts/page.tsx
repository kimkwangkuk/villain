...
import { collection, query, orderBy, limit, startAfter, getDocs, doc, getDoc, where, QueryDocumentSnapshot, DocumentData } from 'firebase/firestore';
...
export default function PostsPage() {
  ...
  const handleShare = async (e: any, postId: string) => {
    e.preventDefault();
    e.stopPropagation();
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          >
            ...
            {categories.map((category) => {
              const orderKey = `order${category.order}` as keyof typeof categoryIconMapping;
              const IconComponent = categoryIconMapping[orderKey] || AllCategoryIcon;
              return (
                <button
                  key={category.id}
