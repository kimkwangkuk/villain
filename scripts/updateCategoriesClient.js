...
const categories = [
  ...
  { "order": 5, "id": "public_office", "name": "공공기관", "description": "공무원, 공기업 직원들이 겪는 문제 상황. 예시: 과도한 민원, 공공시설 훼손, 무리한 요구" },
  ...
  { "order": 12, "id": "police", "name": "경찰", "description": "경찰이 업무 중 겪는 문제 상황. 예시: 시민과의 마찰, 불필요한 신고, 내부 갈등" },
  { "order": 13, "id": "firefighting", "name": "소방", "description": "소방관이 업무 중 겪는 문제 상황. 예시: 허위 신고, 장비 부족, 위험한 출동 상황" },
  { "order": 14, "id": "military", "name": "군대", "description": "군대에서 발생하는 문제 상황. 예시: 가혹 행위, 부조리, 무책임한 간부" },
];
